...
actor Dip20Token {
	...
	stable var logo_ : Text = "https://pbs.twimg.com/profile_images/1528550659536343040/mUimoVzV_400x400.jpg";
	
	stable var decimals_ : Nat8 = 2;
	
	stable var name_ : Text = "MetaBio Token";
	
	stable var totalSupply_ : Nat = 1000000000;
	
	stable var symbol_ : Text = "MBT";
